...
Windows PowerShell:
    ...
    wget https://repo1.maven.org/.../flink-connector-kafka-1.17.1.jar -OutFile flink-connector-kafka-1.17.1.jar

    wget https://repo1.maven.org/.../flink-json-1.17.1.jar -OutFile flink-json-1.17.1.jar
    wget https://repo1.maven.org/.../flink-connector-jdbc-3.1.0-1.17.jar -OutFile flink-connector-jdbc-3.1.0-1.17.jar

    wget https://repo1.maven.org/.../clickhouse-jdbc-0.6.0-all.jar -OutFile clickhouse-jdbc-0.6.0-all.jar

    wget https://repo1.maven.org/.../kafka-clients-3.2.3.jar -OutFile kafka-clients-3.2.3.jar

    wget https://repo1.maven.org/.../flink-connector-clickhouse-1.0.0.jar -OutFile flink-connector-clickhouse-1.0.0.jar

    wget https://repo1.maven.org/.../flink-connector-clickhouse-1.17-0.1.1-all.jar -OutFile flink-connector-clickhouse-1.17-0.1.1-all.jar

    wget https://repo1.maven.org/.../flink-shaded-guava-30.1.1-jre-16.1.jar -OutFile flink-shaded-guava-30.1.1-jre-16.1.jar
